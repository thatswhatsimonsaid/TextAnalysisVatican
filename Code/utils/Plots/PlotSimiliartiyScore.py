...
def CreateCombinedProximityPlot(ResultsDF1, ResultsDF2, ConceptName1A, ConceptName1B, ConceptName2A, ConceptName2B):
    ...
    with the legend inside the plot in the upper left corner.
    ...
    # Place legend inside the plot in the upper left corner with white background and border
    legend = ax.legend(loc='upper left', fontsize=12, framealpha=0.9, frameon=True, 
    ...
    # Use full figure width since legend is now inside
    plt.tight_layout()
