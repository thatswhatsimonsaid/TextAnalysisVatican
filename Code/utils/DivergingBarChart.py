...
def DivergingBarChartFunction(DF_Input, Col1, Col2, NWords=15, figsize=(12, 8)):
    ...
    ### Sort ###
    DF_Filtered = DF_Input[[Col1, Col2]].copy()  # Ensure it's a copy of the DataFrame to avoid the warning
    DF_Filtered.loc[:, "Difference"] = DF_Filtered[Col1] - DF_Filtered[Col2]  # Use .loc for setting values
    ...
    ## Aesthetics ##
    ax.set_xlabel('Difference in Word Frequency Percentage')
